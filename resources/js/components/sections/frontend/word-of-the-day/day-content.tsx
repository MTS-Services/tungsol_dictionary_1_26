      ...
      <section className="relative lg:py-20 py-8 z-10 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative">
          ...
          <div className="max-w-6xl mx-auto bg-btn-primary rounded-3xl p-12 text-center shadow-2xl font-arial">
            ...
            <Link href={route('dictionary')} className="font-regular font-arial inline-flex font-sm items-center gap-2 bg-white text-blue-600 px-8 py-3.5 rounded-xl hover:bg-blue-50 transition-colors shadow-lg">
              Get Started Free

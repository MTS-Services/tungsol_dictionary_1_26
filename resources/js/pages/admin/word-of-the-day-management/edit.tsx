...
export default function EditWordOfTheDay({ wordOfTheDay, words }: Props) {
    const { data, setData, put, processing, errors, reset } = useForm({
        word_id: wordOfTheDay.word_id.toString(),
    ...
    return (
        <AdminLayout activeSlug="word-of-the-day-management">
            <Head title="Edit Word of the Day" />

            <CardHeader className="flex flex-row items-center justify-between">
                <h1 className="text-2xl font-bold">Edit Word of the Day</h1>
                <ActionButton
                    IconNode={ArrowLeft}

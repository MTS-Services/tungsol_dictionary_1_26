...
>
  ...
  <div className="relative z-10 w-full max-w-6xl space-y-4 bg-white p-4">
    ...
    <div className="flex items-center gap-2 text-xs text-slate-500 font-medium mb-6">
      ...
      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
      <span className="text-foreground font-arial font-medium text-sm">Serendipity</span>
    </div>

    <div className="bg-white rounded-2xl shadow-sm p-4">
      <div className="flex justify-between items-start mb-2">
      <h1 className="text-4xl font-medium text-foreground font-arial">Serendipity</h1>
    ...
    <p className="text-gray-500 text-md font-inter ">/S-e-r-e-n-d-i-p-i-t-y/</p>
    </div>
    ...
    <div className="bg-white rounded-2xl shadow-sm p-4">
      ...
      <div className="space-y-6 px-4">
        <div>
          ...
          <p className="mt-3 text-slate-700 font-medium font-arial">The state or quality of being Serendipity.</p>
          <div className="mt-2 bg-slate-50/80 border-l-4 border-blue-500 p-4 rounded-lg">
            ...
            <p className="text-sm italic text-foreground">"The Serendipity of the landscape was breathtaking."</p>
          </div>
        </div>

        <div>
          <p className="text-slate-700 font-medium font-arial">Something that possesses the characteristics of Serendipity.</p>
          <div className="mt-2 bg-slate-50/80 border-l-4 border-blue-500 p-4 rounded-lg">
            <p className="text-xs text-gray-400 font-medium font-arial mb-1 uppercase tracking-tight">Example:</p>
            <p className="text-sm italic text-foreground">"She found Serendipity in the simple things in life."</p>
          </div>
        </div>
        ...
        <div className="pt-4">
          ...
          <div className="mt-2 bg-slate-50/80 border-l-4 border-blue-500 p-4 rounded-lg">
            <p className="text-xs text-gray-400 font-medium font-arial mb-1 uppercase tracking-tight">Example:</p>
            <p className="text-sm italic text-foreground">"It was a Serendipity day for a walk in the park."</p>
          </div>
        </div>
      </div>
    </div>

...
<div
    ...
    <div className="max-w-5xl container mx-auto">
        <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-medium text-slate-800 mb-2 font-arial px-12 lg:px-4">Word Guess Game</h1>
            <p className="text-slate-600 font-medium font-arial text-wrap px-12 lg:px-4">Challenge your vocabulary and have fun!</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-white rounded-2xl shadow-2xl p-8">
               ...
               <div className="flex flex-row gap-4 w-full">
                {/* Play Now Button */}
                <button className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold lg:py-3 lg:px-6 py-2 px-4 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2">
                ...
                <button className="flex-1 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold lg:py-3 lg:px-6 py-2 px-4 rounded-xl transition-all shadow-sm">
                    Play as Guest
                </button>
                </div>
            </div>

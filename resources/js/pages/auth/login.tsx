                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input onChange={e=> setData('password', e.target.value.trim())} type="password" placeholder="Type your password"  className="w-full pl-10.5 pr-4 py-6.5! bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"/>
